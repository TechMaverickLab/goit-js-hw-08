 ...
 */var C=function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"addEventListener",o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:"removeEventListener",i="string"==typeof t?[t]:t;return i.forEach(function(t){e[r](t,n)}),{cancel:function(){return i.forEach(function(t){return e[o](t,n)})}}},F=void 0!==Array.prototype.indexOf,N="undefined"!=typeof window&&void 0!==window.postMessage;if(!j&&(!F||!N))throw Error("Sorry, the Vimeo Player API is not available in this browser.");var L="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==a?a:"undefined"!=typeof self?self:{};!/*!
 ...
 * @return {void}
 */function I(e,t,n){var r=R.get(e.element)||{};t in r||(r[t]=[]),r[t].push(n),R.set(e.element,r)}/**
 * Get the callbacks for a player and event or method.
 *
 * @param {Player} player The player object.
 * @param {string} name The method or event name
 * @return {function[]}
 */function q(e,t){return(R.get(e.element)||{})[t]||[]}/**
 ...
 */var Y={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},$=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&w(e,t)}(a,e);var t,n,r,o,i=(t=k(),function(){var e,n=b(a);if(t){var r=b(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return T(e)}(this,e)});/**
   ...
   */function a(e,t){var n,r,o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},u=arguments.length>3?arguments[3]:void 0;return v(this,a),g(T(r=i.call(this)),"logger",void 0),g(T(r),"speedAdjustment",0),/**
     ...
     * @return {Promise<void>}
     */function(e,t){return new Promise(function(n){!function r(){e.readyState===t?n():e.addEventListener("readystatechange",r,{once:!0})}()})}}]),a}(/*#__PURE__*/x(EventTarget)),B=new WeakMap,Q=new WeakMap,X={},J=/*#__PURE__*/function(){var e;/**
   * Create a Player.
   *
 ...
 * @return {void}
 */function(e,t){t=D(t);var n,r=[];if(t.event)"error"===t.event&&q(e,t.data.method).forEach(function(n){var r=Error(t.data.message);r.name=t.data.name,n.reject(r),V(e,t.data.method,n)}),r=q(e,"event:".concat(t.event)),n=t.data;else if(t.method){var o=/**
 * Return the first stored callback for a player and event or method.
 *
 * @param {Player} player The player object.
 * @param {string} name The method or event name.
 * @return {function} The callback, or false if there were none
 */function(e,t){var n=q(e,t);if(n.length<1)return!1;var r=n.shift();return V(e,t,r),r}(e,t.method);o&&(r.push(o),n=t.value)}r.forEach(function(t){try{if("function"==typeof t){t.call(e,n);return}t.resolve(n)}catch(e){// empty
...
r.element=i,r._originalElement=e,n=e,o=R.get(n),R.set(i,o),R.delete(n),B.set(r.element,r),t)}).catch(n)}});if(// Store a copy of this Player in the map
Q.set(this,a),B.set(this.element,this),"IFRAME"===this.element.nodeName&&W(this,"ping"),X.isEnabled){var u=function(){return X.exit()};this.fullscreenchangeHandler=function(){X.isFullscreen?I(r,"event:exitFullscreen",u):V(r,"event:exitFullscreen",u),// eslint-disable-next-line
r.ready().then(function(){W(r,"fullscreenchange",X.isFullscreen)})},X.on("fullscreenchange",this.fullscreenchangeHandler)}return this}return(/**
...
return t.ready().then(function(){I(t,e,{resolve:r,reject:o}),W(t,e,n)}).catch(o)})}},{key:"get",value:function(e){var t=this;return new A(function(n,r){// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
return e=O(e,"get"),t.ready().then(function(){I(t,e,{resolve:n,reject:r}),W(t,e)}).catch(r)})}},{key:"set",value:function(e,t){var n=this;return new A(function(r,o){if(e=O(e,"set"),null==t)throw TypeError("There must be a value to set.");// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
return n.ready().then(function(){I(n,e,{resolve:r,reject:o}),W(n,e,t)}).catch(o)})}},{key:"on",value:function(e,t){if(!e)throw TypeError("You must pass an event name.");if(!t)throw TypeError("You must pass a callback function.");if("function"!=typeof t)throw TypeError("The callback must be a function.");0===q(this,"event:".concat(e)).length&&this.callMethod("addEventListener",e).catch(function(){// Ignore the error. There will be an error event fired that
...
return!!document[r.fullscreenEnabled]}}}),X=i,/**
 ...
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;//  Prevent execution if users include the player.js script multiple times.
window.VimeoSeoMetadataAppended||(window.VimeoSeoMetadataAppended=!0,window.addEventListener("message",function(t){if(_(t.origin)){var n=D(t.data);if(n&&"ready"===n.event)for(var r=e.querySelectorAll("iframe"),o=0;o<r.length;o++){var i=r[o],a=i.contentWindow===t.source;M(i.src)&&a&&new J(i).callMethod("appendVideoMetadata",window.location.href)}}}))}(),/**
 * Seek to time indicated by vimeo_t query parameter if present in URL
 *
 * @param {HTMLElement} [parent=document] The parent element.
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;//  Prevent execution if users include the player.js script multiple times.
if(!window.VimeoCheckedUrlTimeParam){window.VimeoCheckedUrlTimeParam=!0;var t=function(e){"console"in window&&console.error&&console.error("There was an error getting video Id: ".concat(e))};window.addEventListener("message",function(n){if(_(n.origin)){var r=D(n.data);if(r&&"ready"===r.event)for(var o=e.querySelectorAll("iframe"),i=0;i<o.length;i++)!function(){var e=o[i],r=e.contentWindow===n.source;if(M(e.src)&&r){var a=new J(e);a.getVideoId().then(function(e){var t=new RegExp("[?&]vimeo_t_".concat(e,"=([^&#]*)")).exec(window.location.href);if(t&&t[1]){var n=decodeURI(t[1]);a.setCurrentTime(n)}}).catch(t)}}()}})}}());var K=l("eMXxl");const Z=document.getElementById("vimeo-player"),ee=new J(Z);ee.on("timeupdate",(K&&K.__esModule?K.default:K)(function(e){localStorage.setItem("videoplayer-current-time",e.seconds)},1e3));const et=localStorage.getItem("videoplayer-current-time");et&&ee.setCurrentTime(et).catch(e=>{e.name});//# sourceMappingURL=02-video.dcc4794b.js.map

//# sourceMappingURL=02-video.dcc4794b.js.map
