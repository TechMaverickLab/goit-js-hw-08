...
/* global document, localStorage */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function updateEmailPlaceholder() {
    if (refs.email.value === "") refs.email.placeholder = lastValidEmail || "you@example.com";
}
